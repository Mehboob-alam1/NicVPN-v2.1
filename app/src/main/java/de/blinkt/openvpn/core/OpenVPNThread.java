...
public class OpenVPNThread implements Runnable {
    ...
    private static final String BROKEN_PIE_SUPPORT = "/data/data/com.tunnelcatvpn.android/cache/pievpn";
    ...
    public void run() {
        try {
            ...
            if (!mNoProcessExitStatus)
                VpnStatus.updateStateString("NOPROCESS", "Not Connected, Not Safe!", R.string.state_noprocess, ConnectionStatus.LEVEL_NOTCONNECTED);
