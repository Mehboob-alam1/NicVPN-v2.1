...
import com.nicadevelop.nicavpn.databinding.ActivityBypassListBinding
...
//                }
        ...
        binding.switchPerAppProxy.isChecked = defaultSharedPreferences.getBoolean(AppConfig.PREF_PER_APP_PROXY, true)
