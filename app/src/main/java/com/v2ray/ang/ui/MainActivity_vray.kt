...
import com.nicadevelop.nicavpn.databinding.ActivityMainVrayBinding
import com.tencent.mmkv.MMKV
import com.v2ray.ang.AppConfig.ANG_PACKAGE
import com.v2ray.ang.SimpleItemTouchHelperCallback
...
class MainActivity_vray : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    private lateinit var binding: ActivityMainVrayBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMainVrayBinding.inflate(layoutInflater)
...
//                tv_test_state.text = getString(R.string.connection_test_fail)
    ...
    private fun migrateLegacy() {
        lifecycleScope.launch(Dispatchers.IO) {
            val result = AngConfigManager.migrateLegacyConfig(this@MainActivity_vray)
            if (result != null) {
